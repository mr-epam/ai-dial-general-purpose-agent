...
class ImageGenerationTool(DeploymentTool):
    ...
    async def _execute(self, tool_call_params: ToolCallParams) -> str | Message:
        ...
        attachments = [attachment for attachment in result.custom_content.attachments if attachment.type in ["image/png", "image/jpeg"]]
        ...
        if not result.content:
            # tool_call_params.choice.append_content('The image has been successfully generated according to request and shown to user!')
    ...
    def description(self) -> str:
        ...
        # return "Generate an image according to the prompt."
