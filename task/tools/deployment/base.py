...
class DeploymentTool(BaseTool, ABC):
    ...
    async def _execute(self, tool_call_params: ToolCallParams) -> str | Message:
        ...
        if prompt:
            # tool_call_params.stage.append_content(prompt)
        ...
        async_dial = AsyncDial(base_url=self.endpoint, api_key=tool_call_params.api_key, api_version='2025-01-01-preview')
        ...
        return Message(
            role=Role.TOOL, 
            content=StrictStr(collected_content), 
