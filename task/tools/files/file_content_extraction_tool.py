...
class FileContentExtractionTool(BaseTool):
    ...
    def description(self) -> str:
        ...
        return "Extracts text content from files. Supported: PDF (text only), TXT, CSV (as markdown table), HTML/HTM. Pagination enabled for files >10,000 chars."
    ...
    async def _execute(self, tool_call_params: ToolCallParams) -> str | Message:
        ...
        content = extractor.extract_text(file_url=file_url)
